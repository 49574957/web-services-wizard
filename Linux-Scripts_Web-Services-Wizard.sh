...
yum install -y php php-cli php-curl php-pecl-mysql php73-php-pecl-mysql php73-build.x86_64 php73-php-cli.x86_64 php73-php-common.x86_64 php73-php-dba.x86_64 php73-php-gd.x86_64 php73-php-mysqlnd.x86_64 php73-php-pdo.x86_64 php73-php-pdo-dblib.x86_64 php73-php-pear.noarch
